...
@traceable(name="load_pdf", tags=['pdf', 'doc_loader'], metadata={'pdf_loader': 'PyPDFLoader'})
...
@traceable(name="build_vectorstore", tags=['embedding', 'vector_store'], metadata={'embedding_model': 'embed-english-v3.0'})
